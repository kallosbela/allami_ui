...
for (let i = 0; i < magazines.cards.length; i++) {
  container.innerHTML += `
  <section class="card">
      <div class="sub">$ ${magazines.cards[i].sub} / YEAR</div>
      <div class="textcontainer">
        <div class="title">${magazines.cards[i].title}</div>
        <div class="text">${magazines.cards[i].text}</div>
      </div>
      <div class="button">Subscribe here<a href="#"><span class="material-icons">arrow_forward</span></a></div>
    </section>
  `;
}
